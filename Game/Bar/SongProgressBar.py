...
class SongProgressBar:
    ...
    """
    def __init__(self, x, y, width, height, duration_ms,
                 bar_color=(138, 92, 246), bg_color=(60, 60, 60),
                 show_time=True, font=None):
        self.x = x
        self.y = y
        self.width = width
        self.height = height
        self.duration_ms = duration_ms   # duração total da música em ms
    ...
    def update(self, current_ms):
        """Atualiza o progresso. Recebe o tempo atual em ms (mixer.music.get_pos())."""
    ...
    def draw(self, screen):
        ...
        if self.show_time:
            ...
            screen.blit(tot, (self.x + self.width - tot.get_width(),
